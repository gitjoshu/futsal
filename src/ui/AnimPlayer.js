		...
		return (
			...
			>
				<Grid container alignItems="center">
					<Grid item>
						<FormControlLabel control={<Switch checked={this.props.pathsVisible} onChange={this.showPaths} />} labelPlacement="start" label="Rutas" />
						<Tooltip title="Repetir animación">
							<IconButton aria-label="Repetir animación" color="inherit" onClick={this.repeatToggle}>
								{this.renderRepeat()}
							</IconButton>
						</Tooltip>
						<Tooltip title="Anterior fotograma">
							<span>
								<IconButton aria-label="Anterior fotograma" color="inherit" onClick={this.keyFramePrevious} disabled={this.keyFramePreviousDisabled()}>
									<SkipPrevious />
								</IconButton>
							</span>
						</Tooltip>
						<Tooltip title="Play/Pause animación">
							<IconButton aria-label="Play/Pause animación" color="inherit" onClick={this.playPause}>
								{this.renderPlayPause()}
							</IconButton>
						</Tooltip>
						<Tooltip title="Siguiente fotograma">
							<span>
								<IconButton aria-label="Siguiente fotograma" color="inherit" onClick={this.keyFrameNext} disabled={this.keyFrameNextDisabled()}>
									<SkipNext />
								</IconButton>
							</span>
						</Tooltip>
						<Tooltip title="Parar animación">
							<span>
								<IconButton aria-label="Parar animación" color="inherit" onClick={this.stop} disabled={this.stopDisabled()}>
									<Stop />
								</IconButton>
							</span>
						</Tooltip>
