...
class SaveDialog extends Component {
	...
	nameBlur(e) {
		this.isValidRequired(e.target, "El nombre es requerido")
	}
	...
	render() {
		return (
			<Dialog fullWidth={true} maxWidth={"sm"} open={this.state.open} onClose={this.handleClose} aria-labelledby="responsive-dialog-title">
				<DialogTitleClose id="responsive-dialog-title" onClick={this.handleClose}>{this.state.saveAs ? "Guardar como nuevo" : "Guardar"} pizarra táctica</DialogTitleClose>
				<DialogContent dividers>
					...
					<TextField 
						...
						placeholder="Breve descripción de tácticas" 
