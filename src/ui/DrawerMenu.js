	...
	render() {
		return (
			<Drawer anchor="left" open={this.state.drawerOpen} onClose={this.ToggleDrawer}>
				<Box p={2}>
					<Typography variant="h4" component="h2">Menú</Typography>
					<Divider />
					<List component="nav" aria-label="main mailbox folders">
						<ListItem>
							<ListItemButton onClick={this.newScheme}>
								<ListItemIcon><OpenInNew /></ListItemIcon>
								<ListItemText primary="Nuevo esquema" />
							</ListItemButton>
						</ListItem>
						<Divider />
						<ListItem>
						...
						<ListItem>
							<ListItemButton onClick={this.load} disabled={!this.props.isSignedIn}>
								...
								<ListItemText primary="Explorar mis animaciones" />
							</ListItemButton>
						</ListItem>
						<ListItem>
						...
						<ListItem>
							<ListItemButton onClick={this.colorPaletteEdit}>
								...
								<ListItemText primary="Paleta de colores" />
							</ListItemButton>
						</ListItem>
					</List>
				</Box>
