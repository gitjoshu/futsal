	...
	render() {
		return (
			<Dialog maxWidth="lg" fullWidth={false} open={this.state.open} onClose={this.handleClose} aria-labelledby="responsive-dialog-title">
				<DialogTitleClose id="responsive-dialog-title" onClick={this.handleClose}>Editor de paleta de colores</DialogTitleClose>
				<DialogContent dividers>
					<Box sx={{display: 'flex', flexWrap: 'nowrap'}}>
						<Box sx={{mr:2}}>
							<Typography variant="h6" gutterBottom component="div">Dibujos</Typography>
							...
							<Typography variant="h6" gutterBottom component="div">Equipos</Typography>
							...
							<Typography variant="h6" gutterBottom component="div">Balones</Typography>
				...
				<DialogActions>
					...
					<Button onClick={this.handleOk} variant="contained" color="secondary">Aceptar</Button>
				</DialogActions>
			</Dialog>
		);
	}
