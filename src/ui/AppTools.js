		...
		return (
			<AppBar position="fixed">
				<Toolbar variant="regular">
					...
					<Tooltip title="Ayuda">
						<IconButton aria-label="Ayuda" color="inherit" onClick={this.props.showHelp}>
							<HelpCenterIcon />
						</IconButton>
					</Tooltip>
					<Tooltip title="Compartir enlace">
						<span>
							<IconButton aria-label="Compartir enlace" color="inherit" disabled={!this.props.shareEnabled} onClick={this.props.shareTactics}>
								<LinkIcon />
							</IconButton>
						</span>
					</Tooltip>
