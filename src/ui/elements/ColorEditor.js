	...
	render() {
		...
		return (
			<Box sx={{width:300}}>
				...
				<ColorComponent label="rojo" value={c.red} onChange={this.redChanged} />
				<ColorComponent label="verde" value={c.green} onChange={this.greenChanged} />
				<ColorComponent label="azul" value={c.blue} onChange={this.blueChanged} />
			</Box>
		);
	}
}
