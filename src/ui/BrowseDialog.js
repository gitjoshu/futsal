	...
	render() {
		return (
			<Dialog fullWidth={true} maxWidth="lg" open={this.state.open} onClose={this.handleClose} aria-labelledby="responsive-dialog-title">
				<DialogTitleClose id="responsive-dialog-title" onClick={this.handleClose}>Explore mis tácticas: haga clic en la táctica para abrir en el editor</DialogTitleClose>
				<DialogContent dividers>
					<Stack direction="row" justifyContent="center" spacing={3}>
						...
						/>
						<Button onClick={this.handleSearch} variant="contained" color="primary" autoFocus startIcon={<SearchIcon />}>Buscar</Button>
					</Stack>
					...
					<Stack direction="row" justifyContent="center">
						<LoadingButton
							...
							variant="contained">Más</LoadingButton>
					</Stack>
				</DialogContent>
				{/* <DialogActions>
					<Button onClick={this.handleClose} variant="contained" color="primary" autoFocus>Cancelar</Button>
				</DialogActions> */}
