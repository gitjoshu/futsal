...
class App extends Component {
  ...
  NewScheme() {
    ...
    this.refConfirmDialog.current.Show(
      "Crear nuevo esquema",
      "El esquema se modificó, ¿estás seguro de que deseas descartar los cambios?",
      this.PitchReset
    );
  }
  ...
  NewAnimation() {
    this.refConfirmDialog.current.Show(
      ...
      "¿Estás seguro de que quieres crear una nueva animación?",
      this.AnimCreate
    );
  }
  ...
  DeleteAnimation() {
    this.refConfirmDialog.current.Show(
      "Eliminar animación",
      "¿Está seguro de que desea eliminar la animación, solo se mantendrá el primer cuadro clave?",
      this.AnimDelete
    );
  }
  ...
  ExtrasCreate(t, width, height) {
    this.pitch.extrasCreate(t, this.state.drawMode.color, width, height);
  }
  ...
  renderSignIn() {
    if (this.config.useFirebase) {
      return (
        <SignInDialog
          ref={this.refSignInDialog}
          firebaseApp={this.server.AppInstance}
        />
      );
    }
    return null;
      ...
      <StyledEngineProvider injectFirst>
        <ThemeProvider theme={this.appTheme}>
          ...
          <PitchEdit
            ...
            drawMode={this.state.drawMode}
            centerADURL={this.config.pitchCenterADURL}
          />
          ...
          <PaletteEditorDialog
            ref={this.refPaletteEditorDialog}
            drawMode={this.state.drawMode}
          />
          <SaveDialog ref={this.refSaveDialog} onSave={this.TacticsSave} />
          <BrowseDialog
            ref={this.refLoadDialog}
            onList={this.TacticsList}
            onLoad={this.TacticsLoad}
            onDelete={this.TacticsDelete}
          />
