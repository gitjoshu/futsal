...
class PitchEdit extends Component {
	...
	getRealPosition(e) {
		...
		if (e.touches) {
			...
			deltaX = e.touches[0].clientX - this._mouseX;
			deltaY = e.touches[0].clientY - this._mouseY;
		}
	...
	render() {
		...
		return (
			...
			<div ref={this._editRef} className={pitchClasses}>
				<svg xmlns='http://www.w3.org/2000/svg'  viewBox={viewBox} onContextMenu={this.hContextMenu} onMouseDown={this.hMouseDown} onMouseUp={this.hMouseUp} onMouseMove={this.hMouseMove} onTouchStart={this.hMouseDown} onTouchMove={this.hMouseMove} onTouchEnd={this.hMouseUp}>
					<style>
						{this.generateStyles()}
					</style>
